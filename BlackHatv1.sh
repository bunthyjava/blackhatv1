...
echo  "-AUTORE   : @OwnerMrbunthy              °--)-(--°" | lolcat
echo  " ╭─Telegram                            __[=== o]___" |lolcat
echo  " ╰─https://t.me/BunthyChannel    |_ANONYMOUS_)| $green " |lolcat
echo  "-Anonymous Cam.   $green " |lolcat
echo  "°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°" | lolcat
...
ctrl_c() {
clear
echo -b $green"[#]> I TOOL CHE INSTALLI SONO DISPONIBILI NELLA DIRECTORY BUNTHY " |lolcat
echo -b $green"[#]> Grazie per aver utilizzato il nostro strumento" |lolcat
sleep 1
echo -b $green"[#]> BUNTHY è nel tuo sistema" |lolcat
...
echo -e "========================================================" | lolcat
echo -e "╭─[ANONYMOUS || HACKED]"
read -p "╰→root@./bunthy=" pil;
...
00) echo "AUTORE: BUNTHY" | lolcat
echo "E PERICOLOSO AVERE RAGIONE QUANDO IL GOVERNOHA TORTO" | lolcat
echo "BUNTHY & CAMBODIA TERMUX ASSOCIATION" | lolcat
echo "TUTTI GLI STRUMENTI INSTALLATI SI TROVANO NELLA DIRECTORY BLACK HAT" | lolcat
